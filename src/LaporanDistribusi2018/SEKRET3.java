 ...
 * @author Fauzan13
 */
public class SEKRET3 extends javax.swing.JFrame {
 ...
 public void showData() {
        ...
        try {
            ...
            String query = "SELECT t_transaksi.kd_pelanggan,t_transaksi.nama_barang,SUM(t_transaksi.keluar) as total FROM t_transaksi "
                    + "where kd_pelanggan = 'SEKRE' AND tanggal BETWEEN '2017-07-1' AND '2017-09-30' "
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Bidang Sekretariat");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SEKRET3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
