 ...
 * @author Fauzan13
 */
public class SOCCHMT2 extends javax.swing.JFrame {
 ...
 public void showData() {
        ...
        try {
            ...
            String query = "SELECT t_transaksi.kd_pelanggan,t_transaksi.nama_barang,SUM(t_transaksi.keluar) as total FROM t_transaksi "
                    + "where kd_pelanggan = 'SOCCHM' AND tanggal BETWEEN '2017-04-1' AND '2017-06-30' "
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SOCCHMT2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
